...
<div class="container">
  <div class="py-5 text-center">
    ...
    <div class="col-md-8 order-md-1">
      ...
      <form class="needs-validation" action="AddVendedor.php" method="POST" novalidate>
        <div class="row">
          <div class="col-md">
        ...
        <div class="row">
        <div class="col-md">
          <label for="email">Salario <span class="text-muted">(Obligatorio)</span></label>
          <label for="username"></label>
          <div class="input-group">
            <div class="input-group-prepend">
              <span class="input-group-text">$</span>
            </div>
            <input type="text" class="form-control" id="usuario" name="salario" placeholder="" required>
            <div class="invalid-feedback" style="width: 100%;">
          ...
          <div class="col-md">
          <label for="address">Fecha de inicio</label>
          <input type="text" class="form-control" id="fecha" name="fechaI" placeholder="AAAA/MM/DD" required>
          <div class="invalid-feedback">
        ...
        <hr class="mb-4">
        <button class="btn btn-primary btn-lg btn-block" type="submit">Agregar vendedor</button>
      </form>
    </div>
  </div>
        ...
        <div class="row">
          ...
          <div class="input-group">
            ...
            <div class="invalid-feedback" style="width: 100%;">
             ...
             <div class="mb-3">
          <label for="address">Fecha de inicio</label>
          <input type="text" class="form-control" id="fecha" placeholder="AAAA/MM/DD" required>
          <div class="invalid-feedback">
            Escribe una fecha válida.
          </div>
        </div>
