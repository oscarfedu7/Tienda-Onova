...
<div class="container">
  <div class="py-5 text-center">
    <img class="d-block mx-auto mb-4" src="proveedores.jpg" alt="" width="20%" height="20%">
    ...
    <div class="col-md-8 order-md-1">
      ...
      <form class="needs-validation" action="AddInventario.php" method="POST" novalidate>

        <div class="row">

          <div class="col-md">
          <label for="address">clave del producto</label>
          <input type="text" class="form-control" id="clave" name="clave" placeholder="#0000" required>
        ...
        <div class="col-md">
          <label for="email">Cantidad <span class="text-muted">(Obligatorio)</span></label>
          <label for="username"></label>
          <div class="input-group">
            <div class="input-group-prepend">
              <span class="input-group-text">unidades</span>
            </div>
            <input type="text" class="form-control" id="cant" name="cant" placeholder="" required>
        ...
        <hr class="mb-4">
        <button class="btn btn-primary btn-lg btn-block" type="submit">Agregar al inventario</button>
      </form>
    </div>
  </div>
