...
<div class="container">
  <div class="py-5 text-center">
    ...
    <div class="col-md-8 order-md-1">
      ...
      <form class="needs-validation" action="AddCliente.php" method="POST" novalidate>
        <div class="row">
          <div class="col-md">
            <label for="firstName">Nombre<span class="text-muted"> (Obligatorio)</span></label>
            <input type="text" class="form-control" id="nombre2" name="nombre" placeholder="" value="" required>
        ...
        <div class="mb-3">
          ...
          <div class="input-group">
            ...
            <input type="text" class="form-control" id="cel2" name="cel" placeholder="" required>
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="fecha2" name="fecha" placeholder="AAAA/MM/DD" required>
          <div class="invalid-feedback">
        ...
        <div class="row">
          <div class="col-md-5 mb-3">
            <label for="country">Ciudad<span class="text-muted"> (Obligatorio)</span></label>
            <select class="custom-select d-block w-100" id="ciudad2" name="ciudad" required>
          ...
          <div class="col-md-4 mb-3">
            <label for="state">¿De dónde nos conoce?</label>
            <select class="custom-select d-block w-100" id="conoce2" name="conoce" required>
              <option value="">Choose...</option>
...
<div class="container">
  <div class="py-5 text-center">
    <h2>Registrar como Cliente a un Usuario ya registardo</h2>
  </div>
      ...
      <form class="needs-validation" novalidate>
        <div class="row">
          <div class="col-md">
            ...
            <input type="text" class="form-control" id="id_persona" placeholder="" value="" required>
            <div class="invalid-feedback" >
             El id es requerido.
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-md-4 mb-3">
            <label for="state">¿De dónde nos conoce?</label>
            <select class="custom-select d-block w-100" id="conoce2" required>
              <option value="">Choose...</option>
              <option>Instagram</option>
              <option>Facebook</option>
              <option>Conocido</option>
