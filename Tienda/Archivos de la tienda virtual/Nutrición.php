...
<body>
                ...
                <div class="nav-depart">
                    <div class="depart-btn">
                        ...
                        <ul class="depart-hover">
                            ...
                            <li class="active"><a href="Nutrición.php">Nutrición</a></li>
  ...
  <table class="table table-bordered table-striped">
    ...
    <tbody id="myTable">
      <?php
        $sql = "select * from Producto where categoría_producto='Nutrición'";
      $result = $baseDatos->query($sql);

      if ($result->num_rows > 0) {
        // output data of each row
        while($row = $result->fetch_assoc()) {
          echo "<tr>  <td class='td1'><img src='".$row["imagen"]."'/></td><td>".$row["clave_producto"]."</td><td>".$row["Linea_producto"]."</td><td>".$row["producto"]."</td><td>".$row["categoría_producto"]."</td><td>".$row["costo_producto"]."</td><td>".$row["descripción_producto"]."</td></tr>";
        }
      } else {
        echo "0 results";
      }
