                ...
                <div class="nav-depart">
                    <div class="depart-btn">
                        ...
                        <ul class="depart-hover">
                            ...
                            <li class="active"><a href="CuidadoCabello.php">Cuidado del cabello</a></li>
...
<br><br>
  ...
  <table class="table table-bordered table-striped">
    ...
    <tbody id="myTable">
      ...
      <?php
        $sql = "select * from Producto where categoría_producto='Cuidado del cabello'";
      $result = $baseDatos->query($sql);

      if ($result->num_rows > 0) {
        // output data of each row
        while($row = $result->fetch_assoc()) {
          echo "<tr>  <td class='td1'>  <img src='".$row["imagen"]."'/> 
