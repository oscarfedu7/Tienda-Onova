            ...
            <div class="container">
                ...
                <nav class="nav-menu mobile-menu">
                    <ul>
                        ...
                        <li class="active"><a href="#">Otros</a>
                            <ul class="dropdown">
                ...
                <div class="col-lg-12">
                    <div class="cart-table">
                        <table>
                            ...
                            <tbody>
                                <tr>
                                    <td class="cart-pic first-row"><img src="carbón.jpeg" alt=""></td>
                                    <td class="cart-title first-row">
                                        <h5>Jabón Carbón Activado</h5>
                                    </td>
                                ...
                                <tr>
                                    <td class="cart-pic"><img src="producto1.jpeg" alt=""></td>
                                    <td class="cart-title">
                                        <h5>Proteina Whey </h5>
                                    </td>
                                    <td class="p-price">$1200.00</td>
                                    <td class="qua-col">
                                        <div class="quantity">
                                            <div class="pro-qty">
                                                <input type="text" value="1">
                                    ...
                                    <td class="total-price">$1200.00</td>
                                    <td class="close-td"><i class="ti-close"></i></td>
                                </tr>
                                <tr>
                                    <td class="cart-pic"><img src="producto9.jpeg" alt=""></td>
                                    <td class="cart-title">
                                        <h5>Shapoo EGO</h5>
                                    </td>
                                    ...
                                    <td class="total-price">$120.00</td>
                                    <td class="close-td"><i class="ti-close"></i></td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 offset-lg-4">
                            <div class="proceed-checkout">
                                <ul>
                                    <li class="subtotal">Subtotal <span>$1360.00</span></li>
                                    <li class="cart-total">Total(+Envío) <span>$1380.00</span></li>
                                </ul>
