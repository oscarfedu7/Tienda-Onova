...
<div class="container">
  <div class="py-5 text-center">
    <img class="d-block mx-auto mb-4" src="img/jabónN2.jpeg" alt="" width="19%" height="19%">
    <h2>Lo recomendado para ti</h2>
  </div>


    <div class="col-md-8 order-md-1">
      <h4 class="mb-3">Pon tu email:</h4>
      <form class="needs-validation" action="addRecomendado.php" method="POST" novalidate>
        ...
        <hr class="mb-4">
        <button class="btn btn-primary btn-lg btn-block" type="submit">Ir a recomendados</button>
      </form>
    </div>
  </div>
