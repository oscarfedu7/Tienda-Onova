  ...
  <ul class="navbar-nav ">
    ...
    <li class="nav-item dropdown">
      ...
      <div class="dropdown-menu">
        ...
        <a class="dropdown-item" href="#Ancla">Cliente del mes</a>
      </div>
    </li>
    <!-- Dropdown -->
    <li class="nav-item dropdown">
    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="sidebar-sticky pt-3">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link " href="Proyecto2.php">
...
<div class="container">
  <div class="py-5 text-center">
    <img class="d-block mx-auto mb-4" src="Agregar/venta.webp" alt="" width="20%" height="20%">
    <h2>Registar venta</h2>
  </div>


    <div class="col-md-8 order-md-1">
      <h4 class="mb-3">Agregar datos:</h4>
      <form class="needs-validation" action="AddRegistrarVenta.php" method="POST" novalidate>

        <div class="row">

          <div class="col-md">
          <label for="address">id Vendedor</label>
          <input type="text" class="form-control" id="idvendedor" name="idvendedor" placeholder="#0000" required>
        ...
        <div class="col-md">
          <label for="address">id Cliente</label>
          <input type="text" class="form-control" id="idcliente" name="idcliente" placeholder="#0000" required>
          <div class="invalid-feedback">
            El campo es requerido.
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-md">
          <label for="address">Clave inventario del producto</label>
          <input type="text" class="form-control" id="producto" name="producto" placeholder="#0000" required>
          <div class="invalid-feedback">
            El campo es requerido.
          </div>
        </div>
        ...
        <div class="col-md">
          ...
          <div class="col-md">
          <label for="address">Fecha de venta</label>
        ...
        <hr class="mb-4">
        <button class="btn btn-primary btn-lg btn-block" type="submit">Registar venta</button>
      </form>
    </div>
  </div>
      ...
      <div id="collapseTwo" class="collapse" data-parent="#accordion">
        <div class="card-body">
          ...
          <div class="container">
            ...
            <input class="form-control" id="myInput2" type="text" placeholder="Buscar cliente:">
            <br>
            <table class="table table-bordered table-striped">
                  <th>id Cliente</th> <th>id Vendedor</th> <th>clave Producto</th> <th>Cantidad</th> <th>Fecha de venta</th> 
              <tbody id="myTable">
                <?php
                ...
                if ($result->num_rows > 0) {
                  ...
                  while($row = $result->fetch_assoc()) {
                    echo "<tr><td>".$row["id_cliente"]."</td><td>".$row["id_vendedor"]."</td><td>".$row["clave_producto"]."</td><td>".$row["cantidad"]."</td><td>".$row["fecha_Venta"]."</td></tr>";
                  }
                } else {
                  echo "0 results";
                }
