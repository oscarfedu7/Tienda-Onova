...
<div class="container">
  ...
  <table class="table table-bordered table-striped">
        <th>Clave</th> <th>Producto</th> <th>Línea</th><th>Categoría</th><th>Costo $</th><th>Descripción</th>
    <tbody id="myTable">
      <?php
      ...
      if ($result->num_rows > 0) {
        ...
        while($row = $result->fetch_assoc()) {
          echo "<tr><td>".$row["clave_producto"]."</td><td>".$row["producto"]."</td><td>".$row["Linea_producto"]."</td><td>".$row["categoría_producto"]."</td><td>.".$row["costo_producto"]."</td><td>".$row["descripción_producto"]."</td></tr>";
        }
      } else {
        echo "0 results";
      }
