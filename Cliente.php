  ...
  <ul class="navbar-nav ">
    ...
    <li class="nav-item dropdown">
      ...
      <div class="dropdown-menu">
        ...
        <a class="dropdown-item" href="#">Buscar vendedor</a>
    ...
    <li class="nav-item dropdown">
      ...
      <div class="dropdown-menu">
        <a class="dropdown-item" href="#">Productos que vendemos</a>
        <a class="dropdown-item" href="#">Muestra inventario</a>
        <a class="dropdown-item" href="#">Buscar producto</a>
...
<div class="container">
  ...
  <table class="table table-bordered table-striped">
        <th>id</th> <th>Nombre</th> <th>Fecha de Nacimiento</th><th>Ciudad</th><th>Genero</th><th>Nos conoce por</th>
    <tbody id="myTable">
      <?php
        $sql = "select Persona.id_persona, nombre_persona, fechaNacimiento_persona, ciudad_persona, genero_persona, nosConocePor from Cliente inner join Persona on Cliente.id_persona = Persona.id_persona";
      $result = $baseDatos->query($sql);

      if ($result->num_rows > 0) {
        // output data of each row
        while($row = $result->fetch_assoc()) {
          echo "<tr><td>".$row["id_persona"]."</td><td>".$row["nombre_persona"]."</td><td>".$row["fechaNacimiento_persona"]."</td><td>".$row["ciudad_persona"]."</td><td>".$row["genero_persona"]."</td></td>".$row["nosConocePor"]."</td></tr>";
        }
      } else {
        echo "0 results";
      }
